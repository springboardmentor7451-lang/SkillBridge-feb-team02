  ...
  return (
    <div className="w-full h-screen relative">
      <DotGrid
        ...
        returnDuration={1.5}
      />
      <div className="fixed inset-0 bg-[linear-gradient(to_right,#f4f4f5,transparent,#f4f4f5),linear-gradient(to_bottom,#f4f4f5,transparent,#f4f4f5)]"></div>
      <div className="absolute inset-0 z-20">
        <div className="w-full absolute top-1/2 -translate-y-1/2 text-black flex flex-col items-center justify-center gap-8">
          <h1 className="text-center lg:w-[80%] text-5xl lg:text-8xl font-bold">
            Skill-Based Volunteering That Creates Real Impact
          </h1>
          <button
